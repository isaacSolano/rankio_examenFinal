...
Para este proyecto se utiliza AngularJS en su versión 1.6.9, Bootstrap 4, Jquery 3.3.1, Popper.JS 1.12.9, Sweet Alert 2.1.0, OcLazyLoad 1.1.0 y UIRouter 1.0.15.
...
* [Isaac Solano](https://github.com/isaacSolano/rankio_examenFinal)